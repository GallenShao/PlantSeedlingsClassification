...
def build_net():
	...
	conv333 = conv_layer(conv33, [1, 1, 256 ,256], 1)
	pool3 = pool_layer(conv333, 2, 2)
	
	conv4 = conv_layer(pool3, [3, 3, 256, 512], 1)
	conv44 = conv_layer(conv4, [3, 3, 512, 512], 1)
	conv444 = conv_layer(conv44, [1, 1, 512, 512], 1)
	pool4 = pool_layer(conv444, 2, 2)
	
	conv5 = conv_layer(pool4, [3, 3, 512, 512], 1)
	conv55 = conv_layer(conv5, [3, 3, 512, 512], 1)
	conv555 = conv_layer(conv55, [1, 1, 512, 512], 1)
	pool5 = pool_layer(conv555, 2, 2)
